...
canny2 = cv2.dilate(canny, None, iterations=2)
...
for c in cnts:
    ...
    #Se cambia el valor del epsilon según las necesidades que se tienen para detectar las figuras hechas a mano
